...
void Input::UpdateInput()
{
	...
	//m_mouseWindowCoord = ViewHandler::Get()->getMouseWindowPosition(); //sf::Mouse::getPosition(*m_window);
	m_mousePos = ViewHandler::Get()->getMouseWindowPixelPosition(); //m_window->mapPixelToCoords(m_mouseWindowCoord);
